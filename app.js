...
function render(){
  ...
  if(view==="billing"){
    ...
    main.querySelectorAll("[data-nav-to-detail]").forEach(el=>el.onclick=()=>{
      ...
      openNewEvents=new Set(); recipientPills={}; draftHistory={}; draftRedo={}; aiGenerating=false; drawerThreadId=null; drawerEditing=false; drawerEditActionIdx=null; agentEscalated=false; flagPopoverOpen=false; agentPaused=false; invSort={key:null,dir:"asc"}; invPage=1;
